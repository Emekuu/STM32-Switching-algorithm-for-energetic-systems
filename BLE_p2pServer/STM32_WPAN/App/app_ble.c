...
void APP_BLE_Key_Button1_Action(void)
{
  ...
  // Voláme funkciu priamo bez predošlej ručnej deklarácie.
  // Použijeme index charakteristiky 1 natvrdo.
  P2PS_STM_App_Update_Char(1, (uint8_t *)&update_data);
}
